  ...
  return (
    <div className="stack">
      <PageHeader
        ...
        title="Recalls"
        subtitle="Flag lots for recall to prevent distribution and trace affected custody chains."
        actions={
          <div style={{ display: "flex", gap: 10 }}>
            <button className="btn ghost" onClick={refresh} type="button">Refresh</button>
