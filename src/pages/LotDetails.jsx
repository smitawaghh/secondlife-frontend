...
export default function LotDetails() {
  ...
  // Track which lotId we have loaded so we can reset on navigation between lots
  const [shownLotId, setShownLotId] = useState(lotId);
  const [lot, setLot] = useState(() => normalizeLot(getLotById(lotId)));

  if (shownLotId !== lotId) {
    setShownLotId(lotId);
    setLot(normalizeLot(getLotById(lotId)));
  }
  ...
  function confirmReceived() {
    ...
    if (updated) setLot(normalizeLot(updated));
  }
