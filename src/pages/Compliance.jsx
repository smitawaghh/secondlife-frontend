  ...
  return (
    <div className="stack">
      <PageHeader
        eyebrow="Regulatory"
        title="Compliance"
        subtitle="Rule-based safety and eligibility checks per lot."
        actions={lotId ? (
          <button className="btn ghost" onClick={() => navigate(`/lots/${lotId}`)} type="button">
            ← Back to Lot
          </button>
        ) : null}
      />
